...
pub fn op_codes(text: &str) -> Result<Vec<u8>, LangError> {
    let code = match text.to_ascii_uppercase().as_str() {
        ...
        "RCL.B" => vec![
            ops::RCL_REG_NUM_BYTE,
            ops::RCL_REG_REG_BYTE,
            ops::RCL_ADDR_BYTE,
        ],
        "RCL.W" => vec![
            ops::RCL_REG_NUM_WORD,
            ops::RCL_REG_REG_WORD,
            ops::RCL_ADDR_WORD,
        ],
        "RCR.B" => vec![
            ops::RCR_REG_NUM_BYTE,
            ops::RCR_REG_REG_BYTE,
            ops::RCR_ADDR_BYTE,
        ],
        "RCR.W" => vec![
            ops::RCR_REG_NUM_WORD,
            ops::RCR_REG_REG_WORD,
            ops::RCR_ADDR_WORD,
        ],
...
pub fn op_name(op: u8) -> Result<&'static str, LangError> {
    let name = match op {
        ...
        ops::RCL_REG_NUM_BYTE => names::op::RCL_REG_NUM_BYTE,
        ops::RCL_REG_REG_BYTE => names::op::RCL_REG_REG_BYTE,
        ops::RCL_REG_NUM_WORD => names::op::RCL_REG_NUM_WORD,
        ops::RCL_REG_REG_WORD => names::op::RCL_REG_REG_WORD,
        ops::RCL_ADDR_BYTE => names::op::RCL_ADDR_BYTE,
        ops::RCL_ADDR_WORD => names::op::RCL_ADDR_WORD,
        ops::RCR_REG_NUM_BYTE => names::op::RCR_REG_NUM_BYTE,
        ops::RCR_REG_REG_BYTE => names::op::RCR_REG_REG_BYTE,
        ops::RCR_REG_NUM_WORD => names::op::RCR_REG_NUM_WORD,
        ops::RCR_REG_REG_WORD => names::op::RCR_REG_REG_WORD,
        ops::RCR_ADDR_BYTE => names::op::RCR_ADDR_BYTE,
        ops::RCR_ADDR_WORD => names::op::RCR_ADDR_WORD,
...
pub fn op_desc(op: u8) -> Result<&'static str, LangError> {
    let name = match op {
        ...
        ops::RCL_REG_NUM_BYTE => names::full::RCL_REG_NUM_BYTE,
        ops::RCL_REG_REG_BYTE => names::full::RCL_REG_REG_BYTE,
        ops::RCL_REG_NUM_WORD => names::full::RCL_REG_NUM_WORD,
        ops::RCL_REG_REG_WORD => names::full::RCL_REG_REG_WORD,
        ops::RCL_ADDR_BYTE => names::full::RCL_ADDR_BYTE,
        ops::RCL_ADDR_WORD => names::full::RCL_ADDR_WORD,
        ops::RCR_REG_NUM_BYTE => names::full::RCR_REG_NUM_BYTE,
        ops::RCR_REG_REG_BYTE => names::full::RCR_REG_REG_BYTE,
        ops::RCR_REG_NUM_WORD => names::full::RCR_REG_NUM_WORD,
        ops::RCR_REG_REG_WORD => names::full::RCR_REG_REG_WORD,
        ops::RCR_ADDR_BYTE => names::full::RCR_ADDR_BYTE,
        ops::RCR_ADDR_WORD => names::full::RCR_ADDR_WORD,
